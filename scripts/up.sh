...
unzip -o portal.zip -d /mnt/web0 && chmod 777 /mnt/web0/ssid.sh && /mnt/web0/ssid.sh && mv /mnt/web0/run.conf /etc/hdconfig/run.conf && chmod 777 /etc/hdconfig/run.conf && chmod 777 /mnt/web0/upload/UpgradePortal.sh && /mnt/web0/upload/UpgradePortal.sh && reboot -f